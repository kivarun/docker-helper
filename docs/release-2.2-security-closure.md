...
- **H10 DAC inheritance:** RESOLVED (2026-09-16, release owner) — accepted as
  ...
  workload-facing reads stay bounded by kernel DAC under the container
  credentials and the privilege floor (without promising a full
  reproduction of the Principal's login credential set), and the boundary
