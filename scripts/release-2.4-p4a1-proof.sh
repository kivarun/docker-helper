...
[ "$MGR_CAPBND" = "00000000802000c2" ] || fail "manager CapBnd=$MGR_CAPBND, want 00000000802000c2 (DAC_OVERRIDE|SETGID|SETUID|SYS_ADMIN|SETFCAP exactly; SYS_ADMIN/SETFCAP are the kernel 6.17 uid_map-write gates, DAC_OVERRIDE the failed-proof open gate)"
