#!/usr/bin/env bash
#
# uat-regressions-runner-ubuntu.sh — collect-all runner for the targeted UAT
# regression groups on the Ubuntu / DEB / AppArmor profile (groups 3-19).
#
...
REGRESSIONS=(
  ...
  "19:Run requires Session capability:uat-regression-run-session-only.sh"
)
